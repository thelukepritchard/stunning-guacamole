...
/** EventBridge event source for the bots domain. */
export const BOTS_EVENT_SOURCE = 'signalr.bots';
...
/** Normalised pairs response returned by the exchange API. */
...
/** Normalised order returned by the exchange API. */
...
/** Normalised orders response returned by the exchange API. */
