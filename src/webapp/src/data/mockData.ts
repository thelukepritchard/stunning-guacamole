...
export const bots: Bot[] = [
  {
    ...
    query: {
      ...
      rules: [
        ...
        { field: 'price_change_pct', operator: '<', value: '-3' },
        { field: 'volume_24h', operator: '>', value: '500000000' },
      ],
    },
  },
  {
    ...
    query: {
      combinator: 'and',
      rules: [
        { field: 'macd_signal', operator: '=', value: 'bullish_crossover' },
        {
          combinator: 'or',
          rules: [
  ...
  },
  {
    ...
    query: {
      combinator: 'or',
      rules: [
        { field: 'bb_position', operator: '=', value: 'above_upper' },
        {
          combinator: 'and',
          rules: [
            { field: 'bb_position', operator: '=', value: 'near_upper' },
            { field: 'volume_24h', operator: '>', value: '200000000' },
          ],
        },
      ],
    },
  },
  {
    ...
    query: {
      ...
      rules: [
        ...
        { field: 'ema_12', operator: '>', value: '0' },
      ],
    },
  },
  {
    id: 'bot-5',
    name: 'Multi-Signal Scalper',
    pair: 'LINK/USDT',
    action: 'sell',
    status: 'active',
    ...
    query: {
      combinator: 'and',
      rules: [
        { field: 'rsi_7', operator: '<', value: '25' },
        { field: 'macd_histogram', operator: '>', value: '0' },
        { field: 'bb_position', operator: '=', value: 'below_lower' },
