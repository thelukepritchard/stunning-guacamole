/**
 * Design tokens for the No-code Bot Trading platform.
...
export const gradients = {
  ...
  glow: 'radial-gradient(ellipse at 50% 0%, rgba(0,198,251,0.08) 0%, transparent 60%)',
} as const;
...
export const effects = {
  ...
  shadow: {
    ...
    glow: '0 0 20px rgba(0, 198, 251, 0.15)',
  },
  transition: {
